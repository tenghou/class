...
_page("SELECT pro_id FROM project WHERE pro_sort = '创业训练项目'  AND pro_year='$_year'",10);   //第一个参数获取总条数，第二个参数，指定每页多少条
$_result = _query("SELECT
											pro_name,pro_applicant,pro_college,pro_sort,pro_teacher,pro_state
							  FROM
											project
							WHERE
											pro_sort = '创业训练项目'  AND pro_year='$_year'
						ORDER BY
											pro_No
							LIMIT
											$_pagenum,$_pagesize
