...
define('IN_AC',true);
//定义个常量，用来指定本页的内容
define('SCRIPT','tea_search_current');
//引入公共文件
		...
		<div id=search>
				<form method="get" name="tea_search" action="tea_search_current.php">
					<select class="select" name="type">
						...
						<option <?php if($type==proapplicant) echo 'selected="selected"' ?> value="prosort">按申报人</option>
						<option <?php if($type==procollege) echo 'selected="selected"' ?> value="prosort">按学院</option>
